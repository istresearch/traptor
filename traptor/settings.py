...
RATE_LIMITING_REPORTING_INTERVAL_SEC = max(1.0, float(os.getenv('RATE_LIMITING_REPORTING_INTERVAL_SEC', 120.0)))

RATE_LIMITING_REPORTING_INTERVAL_SEC = max(1.0, float(os.getenv('RATE_LIMITING_REPORTING_INTERVAL_SEC', 1)))
